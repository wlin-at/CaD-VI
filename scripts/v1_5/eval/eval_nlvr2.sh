...
do
  ...
  question_file_path=./eval_json_files/NLVR2.jsonl
  image_folder_dir=/path/to/NLVR2_images/
  conv_mode=vicuna_v1
  inference_mode=generate
  eval_dataset=common_diff
  result_main_dir=/path/to/NLVR2_results
  ...
  python utils/compute_eval_acc/compute_binaryimgselect_acc.py --annot_file $question_file_path --result_file $output_file
